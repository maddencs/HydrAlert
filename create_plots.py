...
def create_plots():
    user = User(pk=1)
    plot1 = add_plot(user=user, light_start="08:00:00", light_stop="16:00:00", currenttemp=54, currenthumid=30, goaltemp=64,
                     goalhumid=35)
    ...
    plot2 = add_plot(user=user, light_start="05:00:00", light_stop="20:00:00", currenttemp=38, currenthumid=54, goaltemp=94,
                     goalhumid=61)
...
def add_plot(user, light_start, light_stop, currenttemp, currenthumid, goaltemp, goalhumid):
    p = PlotZone.objects.get_or_create(user=user, light_start=light_start, light_stop=light_stop, current_temp=currenttemp, current_humid=currenthumid,
